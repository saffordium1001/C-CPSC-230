...
// if decimal is greater than .50, it will round up; if below, round down
...
// //Values need to be doubles with two decimal points - even though they came in as one
...
int main()
{
	...
	cout << "* After each prompt, under your value (as a number) and press enter. *" << endl;
	...
	cout << "Please enter the time it has to do so in seconds and press enter:" << endl;
	cin >> t;
